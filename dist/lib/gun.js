...
exports.attachToGun = function (Gun, options) {
    return Gun.on('create', function (db) {
        var lmdb = (Gun.lmdb = db.lmdb = new client_1.GunLmdbClient(Gun, options));
            ...
            return __awaiter(this, void 0, void 0, function () {
                ...
                return __generator(this, function (_a) {
                    switch (_a.label) {
                        ...
                        case 1:
                            _a.trys.push([1, 3, , 4]);
                            return [4 /*yield*/, lmdb.write(request.put)];
                        case 2:
                            _a.sent();
                            db.on('in', {
                                '@': dedupId,
