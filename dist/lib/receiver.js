...
exports.respondToGets = function (Gun, _a, lmdbOpts) {
    ...
    return function (db) {
        var lmdb = (Gun.lmdb = db.lmdb = new client_1.GunLmdbClient(Gun, lmdbOpts));
            ...
            return __awaiter(this, void 0, void 0, function () {
                ...
                return __generator(this, function (_a) {
                    switch (_a.label) {
                        ...
                        case 1:
                            _a.trys.push([1, 3, , 4]);
                            return [4 /*yield*/, lmdb.getRaw(soul)];
                        case 2:
                            rawResult = _a.sent();
                            put = 'null';
                            if (rawResult) {
...
exports.acceptWrites = function (Gun, _a, lmdbOpts) {
            ...
            return __awaiter(this, void 0, void 0, function () {
                ...
                return __generator(this, function (_a) {
                    switch (_a.label) {
                        ...
                        case 2:
                            _a.trys.push([2, 4, , 5]);
                            return [4 /*yield*/, lmdb.write(diff)];
                        case 3:
                            _a.sent();
